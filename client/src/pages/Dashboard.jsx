...
const Dashboard = () => {
  ...
  return (
    <div className='flex flex-row'>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <a href="/dashboard" className="flex ms-2 md:me-24">
                ...
                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-gray-900">Docs chain</span>
              </a>
            </div>
            <div className="flex items-center">
              <div className="flex items-center ms-3">
              <h1 className="text-gray-800 px-5 font-semibold">Welcome, User</h1>
                {/* User button */}
                <div>
                  <button onClick={toggleDropdown} type="button" className="flex text-sm bg-gray-300 rounded-full focus:ring-4 focus:ring-gray-300" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                    <span className="sr-only">Open user menu</span>
                    <img className="w-8 h-8 rounded-full" src="https://cdn-icons-png.flaticon.com/512/1144/1144760.png" alt="user photo"/>
                  </button>
                </div>
                {/* Dropdown menu */}
                <div className={`absolute right-0 mt-[13rem] ml-[2rem] w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 ${isDropdownOpen ? 'block' : 'hidden'}`} id="dropdown-user">
                  <div className="py-1" role="none">
                  <a href="#" onClick={(e) => { setCurrentPage('settings'); toggleDropdown(); e.preventDefault(); }} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">User Settings</a>
                    <a href="https://github.com/aayushhehe/DocsChain" target='_blank' className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Help</a>
                    <a href="#" onClick={Logout} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Sign out</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className='px-[20rem] py-[7rem]'>
        {renderPage()}
      </div>
    </div>
  );
