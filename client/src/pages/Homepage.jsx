      ...
      <section class="bg-gray-50 py-12 sm:py-16 lg:py-20 xl:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="text-center">
            ...
            <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">Protect your Documents
              in
              4 easy steps
            </h2>
          ...
          <ul class="mx-auto mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
            <li class="flex-start group relative flex lg:flex-col">
              ...
              <div class="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 class="mt-2 text-base text-gray-700">Submit your basic details</h4>
              </div>
            </li>
            <li class="flex-start group relative flex lg:flex-col">
              <span
              ...
              <div class="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 class="mt-2 text-base text-gray-700">Map your fields such as first name, last name, dob etc.</h4>
              </div>
            </li>
            <li class="flex-start group relative flex lg:flex-col">
              <span
              ...
              <div class="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 class="mt-2 text-base text-gray-700">Submit your documents our backend will securely store the hash of your document into our blockchain network.</h4>
              </div>
            </li>
            <li class="flex-start group relative flex lg:flex-col">
              <div
              ...
              <div class="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 class="mt-2 text-base text-gray-700">Access your documents, anytime, anywhere.</h4>
              </div>
            </li>
          </ul>
        </div>
